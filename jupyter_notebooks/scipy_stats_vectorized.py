...
def power_divergence_vectorized(
    f_obs: npt.ArrayLike,
    f_exp: npt.ArrayLike = None,
    ddof: int = 0,
...
def chi2_contingency_vectorized(
    contingency_table: npt.ArrayLike, lambda_: str = "pearson"
) -> Tuple[float, float, npt.ArrayLike]:
    """
    ...
    chi2, p = power_divergence_vectorized(
        contingency_table,
        expected,
        ddof=contingency_table[0].size - 1 - dof,
        axis=(1, 2),
        lambda_=lambda_,
    )
